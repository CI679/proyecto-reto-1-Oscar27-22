...
parse_line() {
  ...
  concept="${concept#[}"        # remove leading "["
}
...
submenu() {
  local method=$1
  local method_arg=${method,,}  # lowercase method string
  local dir="$script_dir/methods"
  local options=(
    "Add Information"
    "Search"
    "Delete Information"
    "Read base of information"
